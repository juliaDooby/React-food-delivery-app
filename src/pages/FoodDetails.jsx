            ...
            <Col lg="2" md="2">
              <div className="product__images">
                <div className="img__item mb-3" onClick={() => setPreviewImg(product.image01)}>
                  <image src={product.image01} alt="" className="w-50" />
                </div>

                <div className="img__item mb-3" onClick={() => setPreviewImg(product.image02)}>
                  <image src={product.image02} alt="" className="w-50" />
                </div>

                <div className="img__item" onClick={() => setPreviewImg(product.image03)}>
                  <image src={product.image03} alt="" className="w-50" />
                </div>
              </div>
            </Col>
            <Col lg="4" md="4"></Col>
            <div className="product__main-img">
              <image src={previewImg} alt="" className="w-100" />
            </div>
            <Col lg="6" md="6">
              <div className="single__product-content">
                <h2 clasName="product__title mb-3">{title}</h2>
